  ...
  return (
    <div className={`text-${mode === 'dark' ? 'light' : 'dark'} border-${mode === 'dark' ? 'light' : 'dark'}`}>
      ...
      <form onSubmit={handleSubmit}>
          <div className="mb-3">
            <label htmlFor="" className='form-label'>Başlık: { baslik } </label>
          ...
          <div className="mb-3">
            ...
            <div className="input-group">
              <input type="text" name="malzeme" ref={malzemeInput} className='form-control' onChange={(e) => setMalzeme(e.target.value)}/>
